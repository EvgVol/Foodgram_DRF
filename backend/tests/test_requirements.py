...
class TestRequirements:
    ...
    def test_requirements(self):
        ...
        assert 'djoser' in requirements, 'Проверьте, что добавили djoser в файл requirements.txt'
        assert 'djangorestframework' in requirements, 'Проверьте, что добавили djangorestframework в файл requirements.txt'
        assert 'drf-extra-fields' in requirements, 'Проверьте, что добавили drf-extra-fields в файл requirements.txt'
