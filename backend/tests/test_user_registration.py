...
class TestUserRegistration:
    ...
    def test_invalid_data_signup(self, client):
        ...
        invalid_username = 'invalid_username@foodgram.cook'
        ...
        valid_email = 'validemail@foodgram.cook'
        invalid_data = {
            'email': valid_email,
        }
        response = client.post(self.url_signup, data=invalid_data)
    ...
    @pytest.mark.django_db(transaction=True)
    def test_valid_data_user_signup(self, client):

        valid_email = 'valid@foodgram.cook'
    ...
    @pytest.mark.django_db(transaction=True)
    def test_valid_data_admin_create_user(self, admin_client):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_obtain_jwt_token_invalid_data(self, client):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_registration_me_username_restricted(self, client):
        valid_email = 'valid@foodgram.cook'
        invalid_username = 'me'
        request_type = 'POST'
    ...
    @pytest.mark.django_db(transaction=True)
    def test_registration_same_email_restricted(self, client):
        valid_email_1 = 'test_duplicate_1@foodgram.cook'
        valid_email_2 = 'test_duplicate_2@foodgram.cook'
